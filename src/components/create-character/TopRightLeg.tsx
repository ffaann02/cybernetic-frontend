import OrangeTopRightLeg from "../../assets/orange-variant/Right_Top_leg.svg";

const Top_RightLeg = ({ choice = 2 }) => {
  return (
    <div>
      {choice === 1 && (
      ...
      {choice === 2 && <img src={OrangeTopRightLeg} alt="Left Top Leg" />}
    </div>
  );
};
export default Top_RightLeg;
