...
const Idle4 = () => {
  return (
    <>
      <div className="absolute z-[50] top-[2rem] left-1/2 transform -translate-x-1/2 w-[8rem] bg-transparent">
        <CharacterHead />
      </div>
      {/* BODY */}
      ...
      {/* LEFT ARM */}
      <div className="absolute top-[40.5%] right-[23.5%] transform -translate-x-[70%] w-[3.25rem] rotate-[65deg] z-[10] bg-transparent">
        <LeftTopArm />
      </div>
      <div className="absolute top-[51%] right-[17.5%] transform -translate-x-[60%] w-[4.5rem] rotate-[100deg] z-10 bg-transparent">
        <LeftHand />
      </div>
      {/* RIGHT ARM */}
      <div className="absolute top-[40.5%] left-[38%] transform -translate-x-1/2 w-[3.25rem] rotate-[-70deg] z-[12] bg-transparent">
        <RightTopArm />
      </div>
      <div className="absolute top-[53%] left-[38%] transform -translate-x-1/2 w-[4.5rem] rotate-[-105deg] z-[12] bg-transparent">
        <RightHand />
      </div>
      {/* LEFT LEG */}
      <div className="absolute top-[64%] right-[36.5%] transform -translate-x-1/2 w-[2rem] z-[6] bg-transparent">
        <LeftTopLeg />
      </div>
      ...
      {/* RIGHT LEG */}
      <div className="absolute top-[64%] left-[44.5%] transform -translate-x-1/2 w-[2rem] z-[6] bg-transparent">
        <RightTopLeg />
      </div>
