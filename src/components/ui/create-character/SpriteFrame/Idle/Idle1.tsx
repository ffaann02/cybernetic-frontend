...
const Idle1 = () => {
  return (
    <>
      <div className="absolute top-[2.5rem] left-1/2 transform -translate-x-1/2 bg-transparent">
        <CharacterHead />
      </div>
      {/* BODY */}
      <div className="absolute top-[8.5rem] left-1/2 transform -translate-x-1/2 z-[4] bg-transparent">
        <Body />
      </div>
      {/* LEFT ARM */}
      <div className="absolute top-[38.5%] right-[23.5%] transform -translate-x-1/2 w-14 rotate-[65deg] z-10 bg-transparent">
        <LeftTopArm />
      </div>
      <div className="absolute top-[51%] right-[17.5%] transform -translate-x-1/2 w-[5rem] rotate-[100deg] z-10 bg-transparent">
        <LeftHand />
      </div>
      {/* RIGHT ARM */}
      <div className="absolute top-[38.5%] left-[38%] transform -translate-x-1/2 w-14 rotate-[-70deg] z-10 bg-transparent">
        <RightTopArm />
      </div>
      <div className="absolute top-[51%] left-[38%] transform -translate-x-1/2 w-[5rem] rotate-[-105deg] z-10 bg-transparent">
        <RightHand />
      </div>
      {/* LEFT LEG */}
