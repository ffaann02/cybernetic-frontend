...
const Running1 = () => {
  return (
    <>
      ...
      {/* LEFT ARM */}
      <div className="absolute top-[42%] right-[23.5%] transform -translate-x-[70%] w-[3.25rem] rotate-[65deg] z-[10] bg-transparent">
        <LeftTopArm />
      </div>
      <div className="absolute top-[50%] right-[10.5%] transform -translate-x-[60%] w-[4.5rem] -scale-y-100 rotate-[-10deg] z-10 bg-transparent">
        <LeftHand />
      </div>
      {/* RIGHT ARM */}
      <div className="absolute top-[40.5%] left-[38%] transform -translate-x-1/2 w-[3.25rem] rotate-[-50deg] z-[12] bg-transparent">
        <RightTopArm />
      </div>
      <div className="absolute top-[53%] left-[37%] transform -translate-x-1/2 w-[4.5rem] rotate-[-100deg] z-[12] bg-transparent">
        <RightHand />
      </div>
      {/* LEFT LEG */}
