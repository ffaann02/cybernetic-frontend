...
import { Level1DataLabEnvironment } from "../../level1-datalab/scene-object/Level1-DataLab";
import { MeterGroup } from "primereact/metergroup";
import { Level2ImageLabEnvironment } from "../scene-object/Level2-ImageLab";
              ...
              <div className="w-full grid grid-cols-3 gap-x-4">
                ...
                <div className="col-span-2 h-full border rounded-xl bg-white/30 p-4">
                  ...
                  <p className="mt-2 text-xl font-bold text-white">
                    Result: <span className="text-green-200">PASS</span>
                  </p>
                </div>
              </div>
            </Fieldset>
